...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"jquery-2.0.3.js":[function(require,module,exports) {
var define;
...
(function (window, undefined) {
  ...
  */
    ...
    if (jQuery.support.cors || xhrSupported && !options.crossDomain) {
      return {
        send: function send(headers, complete) {
          ...
          _callback2 = function callback(type) {
            return function () {
              if (_callback2) {
                ...
                _callback2 = xhr.onload = xhr.onerror = null;
                if (type === "abort") {
                  xhr.abort();
                } else if (type === "error") {
                  complete(
          ...
          xhr.onerror = _callback2("error");
          // Create the abort callback
          _callback2 = xhrCallbacks[id = xhrId++] = _callback2("abort");
          // Do send the request
  ...
  if (_typeof(window) === "object" && _typeof(window.document) === "object") {
    window.jQuery = window.$ = jQuery;
  }
})(window);
},{}],"../../../../../.nvm/versions/node/v16.8.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../.nvm/versions/node/v16.8.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","jquery-2.0.3.js"], null)
//# sourceMappingURL=/jquery-2.0.3.8620ad9e.js.map